...
async def upload_and_process_video(
    ...
    **Returns:**
    ...
    # TEMP: Store-only mode – skip processing for now
    return {
        "success": True,
        "message": "Video uploaded successfully",
        # Frontend expects these fields to render UI; provide placeholder values
        "text": "Video received. Processing is disabled in this build.",
        "confidence": 0.0,
