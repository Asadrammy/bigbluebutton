...
import { FONT_SIZES, SPACING, LANGUAGES, SIGN_LANGUAGES } from '@utils/constants';
            ...
            {Object.entries(LANGUAGES)
              ...
              <TouchableOpacity
                ...
                style={[
                    ...
                    <Text style={[styles.modalOptionText, dynamicStyles.modalItemText]}>{name}</Text>
                  </View>
              </TouchableOpacity>
            ))}
            </ScrollView>
            ...
            {Object.entries(SIGN_LANGUAGES).map(([code, name]) => (
              <TouchableOpacity
                key={code}
                  style={[styles.modalOption, dynamicStyles.modalItem, dynamicStyles.modalOption]}
                  onPress={async () => {
                    await handleSignLanguageChange(code as SignLanguage);
